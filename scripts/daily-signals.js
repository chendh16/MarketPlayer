...
const bot_1 = require("../src/services/feishu/bot");
const DATA_DIR = '/Users/zhengzefeng/.openclaw/workspace/MarketPlayer/data/cache/klines';
// 布林带策略信号
function bollingerSignals(klines, period = 20, stdDev = 2) {
    const signals = [];
...
// 生成ASCII K线图
function drawKlineChart(klines, signals, symbol, days = 30) {
...
// 计算模拟收益
function calcProfit(klines, signals) {
    let profit = 0;
    let shares = 0;
    let cost = 0;
...
async function sendDailySignals() {
    ...
    // 发送
    await (0, bot_1.sendMessageToUser)('ou_3d8c36452b5a0ca480873393ad876e12', { text: msg });
    console.log('✅ 每日信号已推送');
}
// 立即执行
sendDailySignals();
//# sourceMappingURL=daily-signals.js.map